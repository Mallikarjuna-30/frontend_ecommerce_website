    ...
    return (
        <div className='flex w-full h-full items-center justify-center p-5'>
            <div className='flex flex-col h-full w-full justify-center items-center mb-5'>
                <h1 className='text-2xl text-center text-gray-800 font-semibold mb-8 mt-0'>Create an Account</h1>
                ...
                <div className='flex justify-center items-center mt-5'>
                    <p className='text-sm text-gray-700 font-semibold'>Already have an account? <Link to="/login" className='text-blue-400 font-semibold hover:underline cursor-pointer'>Login</Link></p>
                </div>
            </div>
        </div>
    )
