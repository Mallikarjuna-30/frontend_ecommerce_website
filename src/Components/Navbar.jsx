        ...
        <div className='p-3'>
            <div className='flex items-center justify-between p-4 bg-transparent text-black rounded-xl'>
                <div className='flex items-center justify-between w-full ml-5 mr-5'>
                    ...
                    <div className='flex gap-5 text-lg font-medium mr-10'>
                        ...
                        <Link to="/" className="relative after:content-[''] after:absolute after:left-0 after:-bottom-1 after:w-0 after:h-[2px] after:bg-black after:transition-all after:duration-300 hover:after:w-full cursor-pointer">Products</Link>
