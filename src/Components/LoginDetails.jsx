...
const LoginDetails = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Simple navigate back to home store
        navigate('/');
    };
        ...
        <div className="w-full flex flex-col items-center">
            ...
            <div className="w-full space-y-3 mb-5">
                ...
                >
                    ...
                    <span>{showPhoneAuth ? 'Continue with Email' : 'Continue with Phone Number'}</span>
                </button>
            </div>
                ...
                <div className="w-full space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3.5 py-2.5 rounded-xl border border-gray-300 text-sm focus:ring-2 focus:ring-black outline-none"
                        />
                    </div>
                    <button
                        type="button"
                        onClick={() => navigate('/')}
                        className="w-full py-2.5 bg-black hover:bg-gray-800 text-white rounded-xl text-sm font-medium transition-colors cursor-pointer"
                    >
                        Send OTP
                    </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="w-full space-y-4">
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-1">
                            ...
                            <a href="#" onClick={(e) => { e.preventDefault(); alert('Reset link sent to your email.'); }} className="text-xs text-blue-600 hover:underline">
                                Forgot password?
                            </a>
                        </div>
